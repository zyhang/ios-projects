...
## 8. 执行记录（2026-07-31 同日落地）

| 项 | 结果 |
|----|------|
| **007** Support 三源 | **done** |
| **008** 商店 URL + Welcome/Setup 成片 | **done** |
| **009** Help 文案 + screens | **done**（规格）；App UI 待源码 |
| **006** secondary HTML 预览 | **partial** |
| **001–005** | 规格/文案/设计目标就绪；**本仓库无 Swift**，代码待主工程 |
| 文案源 | `docs/engineering/ui-copy-en.md` |
...
| 2026-07-31 | 用户授权「全部执行」：完成文档/站点/商店/导出可改项；代码类 issue 保持 open |
